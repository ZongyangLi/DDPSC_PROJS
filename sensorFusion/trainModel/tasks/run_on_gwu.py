...
import sys
sys.path.append("/pless_nfs/home/zongyangli/pyWork/pytorch-py3/reverse-pheno-master")
...
class Trainer:
    def __init__(self, model, dataloader, loss_func, optimizer, scheduler, n_epochs, acc_func=None, train_name='default', 
        ...
        if self.ckp_dir is None:
            self.ckp_dir = '/pless_nfs/home/zongyangli/pyWork/pytorch-py3/checkpoints/{}/{}'.format(train_name, self.timestamp)
        ...
        self.record_params = ['loss_func', 'step_loss', 'step_acc', 'val_loss']
...
if __name__ == '__main__':
    ...
    train_name='Joint_rgb_laser_gwu_no_rotationAndFlip'
    tb_log_dir = '/pless_nfs/home/zongyangli/pyWork/pytorch-py3/reverse-pheno-master/tasks/tb_logs/{}'.format(train_name)
    ckp_dir = '/pless_nfs/home/zongyangli/pyWork/pytorch-py3/checkpoints/{}/{}'.format(train_name,timestamp)
    ...
    train_dataset = OPENFusionJointDataset('/data/shared/sensorFusion/training_data/joint_rgb_laser/train', transform=image_transform)
    fusion_dateset = TripletNearDateJointDataset(train_dataset, class_by='plot', date_by='scan_date', neighbor_distance=neighbor_distance, collate_fn=None, transform=image_transform)
    dataloader = torch.utils.data.DataLoader(fusion_dateset, batch_size=batch_size, shuffle=True, num_workers=4)
    
    val_dataset = OPENFusionJointDataset('/data/shared/sensorFusion/training_data/joint_rgb_laser/val', transform=val_image_transform)
    ...
    val_dataloader = torch.utils.data.DataLoader(val_fusion_dateset, batch_size=val_batch_size, shuffle=True, num_workers=1)
